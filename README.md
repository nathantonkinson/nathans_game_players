...
- UniWar - try to write AI (or anything) for mobile game UniWar, https://www.uniwar.com/. That folder has it's own readme.

# My current work / Help me out 
If you want to help me out (uniwar friends), mostly take a look at Reversi/reversi.py. It has MCTS, used to have genetic algorithm, and generally my most advanced stuff. The current main problem is why can't MCTS or the genetic algorithm get a net to the point where it plays significantly better than random (best is a 70% winrate so far)? Do I just need more compute? 
