...
Copy the _heuristicExample.py and modify. It is child of _heuristicTemplate heuristicTemplate class so I can make structural changes to all heuristics if needed.
